        ...
        <div className="w-full">
            ...
            <div className="bg-white border border-slate-100 rounded-2xl p-8 shadow-sm">
                <div className="space-y-4">
                    ...
                    {/* Email Sign-up */}
                    <Link href={signUpUrl} className="block">
                        <Button className="w-full h-13 text-lg font-bold bg-slate-900 hover:bg-slate-800 text-white rounded-xl transition-all shadow-md active:scale-[0.98]">
